...
/*   Updated: 2025/07/07 16:35:51 by sikunne          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move(t_data *data, int direction)
{
	...
	delta_x = (MOVE_SPEED * cos(deg_to_rad(data->rot - 90.0 - direction)));
	delta_y = (MOVE_SPEED * sin(deg_to_rad(data->rot - 90.0 - direction)));
